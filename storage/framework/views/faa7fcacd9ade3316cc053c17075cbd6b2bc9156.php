...
<body>
    <?php if(Session::has('empost_add')): ?>
    <span><?php echo e(Session::get('empost_add')); ?></span>
    <?php endif; ?>
                <form method="post" action="<?php echo e(route('emsave.post')); ?>">
                    <?php echo csrf_field(); ?>
                    <center><h2>
                    ...
                    Designation :<br><input type="text" name="designation" value=""><br>
            ...
            </html><?php /**PATH C:\xampp\htdocs\jobportal\resources\views/auth/emadd-post.blade.php ENDPATH**/ ?>