        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4" style="margin-top: 120px;">
                ...
                <left>
                    ...
                    <?php if($data->one == "Html"|| $data->two == "Html" || $data->three == "Html" || $data->four == "Html"): ?>
                    <h2><left>Recommended course : Introduction to Web Development with HTML, CSS, JavaScript(Course ID:2)</left></h2>
                    <?php endif; ?>

                    <?php if($data->one == "Canva"|| $data->two == "Canva" || $data->three == "Canva" || $data->four == "Canva"): ?>
                    <h2><left>Recommended course : Canva for Beginners(Course ID:5)</left></h2>
                    <?php endif; ?>

                    <?php if($data->one == "Power Point"|| $data->two == "Power Point" || $data->three == "Power Point" || $data->four == "Power Point"): ?>
                    <h2><left>Recommended course : Power Point for Beginners(Course ID:6)</left></h2>          <?php endif; ?>


                    <?php if($data->one == "Excel"|| $data->two == "Excel" || $data->three == "Excel" || $data->four == "Excel"): ?>
                    <h2><left>Recommended course : Ben Currier's Excel Exposure(Course ID:4)</left></h2>    
                    <?php endif; ?>
                    
                    <?php if($data->one == "Java"|| $data->two == "Java" || $data->three == "Java" || $data->four == "Java"): ?>
                    <h2><left>Recommended course : Java Programming Basics(Course ID:3)</left></h2>    
                    <?php endif; ?>

                    <?php if($data->one == "Python"|| $data->two == "Python" || $data->three == "Python" || $data->four == "Python"): ?>
...
</html><?php /**PATH C:\xampp\htdocs\jobportal\resources\views/auth/rec.blade.php ENDPATH**/ ?>