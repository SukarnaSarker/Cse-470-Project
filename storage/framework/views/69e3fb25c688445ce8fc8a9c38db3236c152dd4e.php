	...
	<div class="container">
		<div class="row"><center>
			<div class="col-md-4 col-md-offset-4" style="margin-top:150px;">
				...
				<hr>
				<form action="<?php echo e(route('edit-employeredit')); ?>" method="post">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" placeholder="Enter Full Name" name="cname" value="<?php echo e(old('cname')); ?>">
						<span class="text-danger"><?php $__errorArgs = ['cname'];
...
unset($__errorArgs, $__bag); ?></span>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" placeholder="Enter Phone Number" name="phone" value="<?php echo e(old('phone')); ?>">
...
unset($__errorArgs, $__bag); ?></span>
	...
	</html><?php /**PATH C:\xampp\htdocs\jobportal\resources\views/auth/edit.blade.php ENDPATH**/ ?>