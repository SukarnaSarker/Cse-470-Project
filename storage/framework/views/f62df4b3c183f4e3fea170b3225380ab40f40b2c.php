...
<head>
  ...
  <title>Dashboard for employer</title>
    ...
    <div class="navbar-end">
      <div class="navbar-item dropdown has-divider">
        ...
        <div class="navbar-dropdown">
          ...
          <a href="employerlogin" class="navbar-item">
...
<aside class="aside is-placed-left is-expanded">
  <div class="aside-tools">
    <div>
      Employer <b class="font-black">Dashboard</b>
    </div>
  </div>
    ...
    <ul class="menu-list">
      <li class="--set-active-tables-html">
        <a href="emadd-post">
          ...
          <span class="menu-item-label">Post a JOB</span>
        </a>
      </li>
      <li class="--set-active-tables-html">
        <a href="empost-list">
          <span class="icon"><i class="mdi mdi-table"></i></span>
          <span class="menu-item-label">Edit your JOB Post</span>
        </a>
      </li>
      ...
      <li class="--set-active-forms-html">
        <a href="seeker-list">
          <span class="icon"><i class="mdi mdi-square-edit-outline"></i></span>
          <span class="menu-item-label">Available seekers for today</span>
        </a>
      </li>
      <li class="--set-active-forms-html">
        <a href="sorted-seeker-list">
          <span class="icon"><i class="mdi mdi-square-edit-outline"></i></span>
          <span class="menu-item-label">Sorted version of seeker List</span>
        </a>
      </li>
      <li class="--set-active-forms-html">
        <a href="https://www.jobseeker.com/en/cv?gclid=Cj0KCQjw0oyYBhDGARIsAMZEuMvvg8b16UOyoi_K13SJFSEcNv5_siKUU1cAFijKaDPSKJ9-nDxtiiIaAtw_EALw_wcB">
          <span class="icon"><i class="mdi mdi-square-edit-outline"></i></span>
          <span class="menu-item-label">Provide CV format through here</span>
        </a>
      </li>
...
<?php /**PATH C:\xampp\htdocs\jobportal\resources\views/auth/dashboardforemployer.blade.php ENDPATH**/ ?>