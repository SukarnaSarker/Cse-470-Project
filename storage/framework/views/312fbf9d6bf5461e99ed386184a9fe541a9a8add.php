...
<head>
  ...
  <title>Dashboard for Seeker</title>
    ...
    <div class="navbar-end">
      <div class="navbar-item dropdown has-divider">
        ...
        <div class="navbar-dropdown">
          <a href="seekerprofile" class="navbar-item">
      ...
      <a href="https://github.com/SukarnaSarker?tab=repositories" class="navbar-item has-divider desktop-icon-only">
...
<aside class="aside is-placed-left is-expanded">
  <div class="aside-tools">
    <div>
      Seeker <b class="font-black">Dashboard</b>
    </div>
  </div>
    ...
    <ul class="menu-list">
      <li class="active">
        <a href="studentprofile">
          ...
          <span class="menu-item-label">Details information </span>
        </a>
      </li>
      <li class="--set-active-profile-html">
        ...
        <a href="index">
          <span class="icon"><i class="mdi mdi-account-circle"></i></span>
          <span class="menu-item-label">Created CV</span>
        </a>
      </li>
    </ul>
    ...
    <ul class="menu-list">
      <li class="--set-active-tables-html">
        <a href="add-post">
          ...
          <span class="menu-item-label">Edit your Information</span>
        </a>
      </li>
      <li class="--set-active-forms-html">
        <a href="post-list">
          <span class="icon"><i class="mdi mdi-square-edit-outline"></i></span>
          <span class="menu-item-label">Update Your Information</span>
        </a>
      </li>
      <li class="--set-active-forms-html">
        <a href="list">
          <span class="icon"><i class="mdi mdi-table"></i></span>
          <span class="menu-item-label">Trending jobs for today</span>
        </a>
      </li>
      <li class="--set-active-forms-html">
        <a href="sorted-job-list">
          <span class="icon"><i class="mdi mdi-square-edit-outline"></i></span>
          <span class="menu-item-label">Sort Your Favourite Jobs</span>
        </a>
      </li>
      <li class="--set-active-forms-html">
        <a href="seeker-list">
          <span class="icon"><i class="mdi mdi-table"></i></span>
          <span class="menu-item-label">Available Seekers</span>
        </a>
      </li>
      <li class="--set-active-forms-html">
        <a href="uploadportfolio">
          <span class="icon"><i class="mdi mdi-square-edit-outline"></i></span>
          <span class="menu-item-label">Upload Your Portfolio link here</span>
        </a>
      </li>
      <li class="--set-active-forms-html">
        <a href="courses">
          <span class="icon"><i class="mdi mdi-square-edit-outline"></i></span>
          <span class="menu-item-label">Offering Courses</span>
        </a>
      </li>
      <li class="--set-active-forms-html">
        <a href="bookmark">
          <span class="icon"><i class="mdi mdi-square-edit-outline"></i></span>
          <span class="menu-item-label">Your Bookmarks</span>
        </a>
      </li>
      <li class="--set-active-forms-html">
        <a href="rec">
          <span class="icon"><i class="mdi mdi-square-edit-outline"></i></span>
          <span class="menu-item-label">Recommanded Courses</span>
        </a>
      </li>
    </ul>
      ...
      <div class="card">
        <div class="card-content">
          <div class="flex items-center justify-between">
            ...
            <span class="icon widget-icon text-blue-500"><i class="mdi mdi-account-outline mdi-48px"></i></span>
          </div>
        </div>
      </div>
        ...
        <table>
          ...
          <tr>
            ...
            <td data-label="Created">
              <small class="text-gray-500" title="Oct 25, 2021">Oct 25, 2020</small>
            </td>
          ...
          <tr>
            ...
            <td data-label="Created">
              <small class="text-gray-500" title="Sep 13, 2021">Jan 13, 2022</small>
            </td>
            <td class="actions-cell">
              <div class="buttons right nowrap">
                <button class="button small green --jb-modal"  data-target="sample-modal-2" type="button">
          ...
          <tr>
            ...
            <td data-label="Created">
              <small class="text-gray-500" title="Jul 24, 2021">Jul 24, 2022</small>
            </td>
            <td class="actions-cell">
              <div class="buttons right nowrap">
                <button class="button small green --jb-modal"  data-target="sample-modal-2" type="button">
          ...
          <tr>
            ...
            <td data-label="Created">
              <small class="text-gray-500" title="Mar 30, 2021">Mar 30, 2022</small>
            </td>
            <td class="actions-cell">
              <div class="buttons right nowrap">
                <button class="button small green --jb-modal"  data-target="sample-modal-2" type="button">
          ...
          <tr>
            ...
            <td data-label="Created">
              <small class="text-gray-500" title="Feb 12, 2021">Feb 12, 2022</small>
            </td>
            <td class="actions-cell">
              <div class="buttons right nowrap">
                <button class="button small green --jb-modal"  data-target="sample-modal-2" type="button">
          ...
          <tr>
            ...
            <td data-label="Created">
              <small class="text-gray-500" title="Dec 30, 2021">July 28, 2022</small>
            </td>
            <td class="actions-cell">
              <div class="buttons right nowrap">
                <button class="button small green --jb-modal"  data-target="sample-modal-2" type="button">
          ...
          <tr>
            ...
            <td data-label="Created">
              <small class="text-gray-500" title="Jun 28, 2021">Jun 28, 2022</small>
            </td>
            <td class="actions-cell">
              <div class="buttons right nowrap">
                <button class="button small green --jb-modal"  data-target="sample-modal-2" type="button">
          ...
          <tr>
            ...
            <td data-label="Created">
              <small class="text-gray-500" title="Mar 7, 2021">Mar 7, 2022</small>
            </td>
            <td class="actions-cell">
              <div class="buttons right nowrap">
                <button class="button small green --jb-modal"  data-target="sample-modal-2" type="button">
...
<footer class="footer">
  <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0">
    <div class="flex items-center justify-start space-x-3">
      ...
      <div>
        <p>Distributed By: <a href="https://themewagon.com/" target="_blank">Sukarna Sarker</a></p>
      </div>
...
<?php /**PATH C:\xampp\htdocs\jobportal\resources\views/auth/dashboard.blade.php ENDPATH**/ ?>