                            ...
                            <div class="col-md-6">
                                <div class="skills">
                                    <div class="skill-name">
                                        <p>{{$data->four}}</p><p>85%</p>
                                    </div>
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <div class="skill-name">
                                        <p>{{$data->three}}</p><p>95%</p>
                                    </div>
                                    <div class="progress">
                    ...
                    <div class="content-inner">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6">
                                <div class="edu-col">
                                    <h3>Job Interest</h3>
                                    <p>{{$data->workplaceinterest}}</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="edu-col">
                                    <h3>Working Hour Interest</h3>
                                    <p>{{$data->workinghourinterest}}</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="edu-col">
                                    <h3>Salary Interest</h3>
                                    <p>{{$data->salaryinterest}}</p>
                                </div>
                            </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <div class="contact-info">
                                    ...
                                    <p><i class="fa fa-envelope"></i><a href="mailto:info@example.com">{{$data->email}}</a></p>
                                    <p><i class="fa fa-phone"></i><a href="tel:+1234567890">{{$data->phone}}</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
